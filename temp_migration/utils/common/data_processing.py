# Funções de processamento de dados comuns a todos os módulos
import locale
import pandas as pd
...
def processar_datas(df):
    """Função para processamento padrão de datas"""
...
def aplicar_filtro_anos(df, anos_selecionados):
    """
    Filtra o DataFrame pelos anos selecionados
    
    Args:
        df: DataFrame com coluna 'data'
        anos_selecionados: Lista de anos para filtrar
    ...
    return df[df['data'].dt.year.isin(anos_selecionados)]